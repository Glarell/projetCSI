...
class VueAccueilClient extends VuePrincipale
{
    private $id,$name;

    public function __construct($clientName,$clientID)
    {
        $this->id = $clientID;
          ...
          <div class=\"container h-100\">
            <div class=\"row h-100 align-items-center\">
              <div class=\"col-12 text-center\">
                ...
                <br> 
                <p style=\"color:red\" class=\"lead\">Vous êtes connecté en tant que CLIENT</p>
                <p style=\"color:red\" class=\"lead\">Bonjour, Mr/Mm $this->name, avec un idClient = $this->id</p>
                <br>
